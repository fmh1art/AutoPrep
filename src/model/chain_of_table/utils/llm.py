...
class ChatGPT:
    ...
    def get_model_options(
        ...
        return dict(
            ...
            n=1 if 'deepseek' in self.model_name else n_sample,
    ...
    def generate_plus_with_score(self, prompt, options=None, end_str=None):
        ...
        openai.api_key = api_key=self.key
        openai.base_url = self.base_url
        while gpt_responses is None:
            try:
                gpt_responses =  OpenAI().chat.completions.create(
                ...
                print("error in llm",str(e), flush=True)
                error = str(e)
        ...
        print("gpt_responses",gpt_responses.choices[0].message.content)
