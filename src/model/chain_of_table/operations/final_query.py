...
*/
Question: Is bike number 3  the only one to use equipment ktm - ayr?
The anwser is: NO
...
*/
Question: How many percentage points lower was the popular vote in the 1937 election compared to the 1934 election?.
The anwser is: 1.4%
"""
...
def simple_query(sample, table_info, llm, debug=False, use_demo=False, llm_options=None):
    ...
    prompt = ""
    prompt += "Here are the question about the table and the task is to answer the question.\n"
